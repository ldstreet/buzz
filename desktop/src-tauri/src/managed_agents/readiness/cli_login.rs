use crate::managed_agents::{
    discovery::{classify_runtime, find_command, resolve_command, KnownAcpRuntime},
...
pub(super) fn requirements(
    ...
    match availability {
        AcpAvailabilityStatus::Available => {
            ...
            if cli_probe::login_probe_succeeds(&binary_path, probe_args, augmented_path.as_deref())
            {
                vec![]
            } else {
